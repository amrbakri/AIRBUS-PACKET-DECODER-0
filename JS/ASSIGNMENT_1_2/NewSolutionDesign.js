...
function applyPacketOperator(packet) {
    ...
    switch (packet.type.decimalRepr) {
        ...
        case 8:
            if (values.length !== 2) {
                throw new Error(`Operator 'not equal' expects exactly 2 operands, got ${values.length}`);
            }
            operator = "not equal";
            result = values[0] !== values[1] ? 1 : 0;
        break;
        ...
        case 9:
            operator = "xor";
            // if (values.length !== 2) {
            //   throw new Error(`Operator 'xor' expects exactly 2 operands, got ${values.length}`);
            // }
...
// "0b 001 100 1 0001 001 001 1 000001010"
"0b 010 111"
    // "0b 001 1000 1 00000000000 001 0100 0 100 0000 0100 0 0100 0 1111"
// //  "0b 001 1000 0 000000000011110 101 0100 0 0001 010 0100 0 1111"
    // "0b 001 000 0 000010010000000 010 000 0000"
    ...
    // "0b 001 1010 1 00000000010 001 0100 0 0010 100 0100 0 0010  00"
    //  vvv tttt i <----11---> vvv tttt F bbbb vvv tttt F bbbb
...
const operatorsResult = applyPacketOperator(result)
console.log("Operator:",operatorsResult.operator);
console.log("Operands:",operatorsResult.operands);
console.log("Evaluation:",operatorsResult.result);
